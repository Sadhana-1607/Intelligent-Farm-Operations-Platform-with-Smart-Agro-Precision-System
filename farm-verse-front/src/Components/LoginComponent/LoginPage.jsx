...
const LoginPage = () => {
  ...
  const validateLogin = (e) => {
    ...
    validateUser(loginData.username, loginData.password).then((response) => {
      ...
      if (reply === "True" || reply === "true") navigate("/farmer-menu");
      else setFlag(false);
    });
  };
        ...
        <Card.Body className="p-5">
          ...
          <Form>
            ...
            <div className="d-grid mt-4">
              <Button variant="success" size="lg" onClick={handleValidation}>
                Login
              </Button>
            </div>

            {!flag && (
              <p className="text-center mt-3" style={{ color: "#ffaaaa" }}>
                Invalid Username or Password
              </p>
            )}

            <div className="text-center mt-4">
              <Button variant="outline-light" onClick={registerNewUser}>
                Register New User
              </Button>
            </div>
          </Form>
...
//               {!flag && <p className="error">Invalid User ID or Password</p>}
//             </div>
