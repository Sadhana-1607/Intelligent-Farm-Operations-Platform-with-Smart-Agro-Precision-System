...
const FarmerMenu = () => {
  ...
  return (
    <>
      ...
      >
        <Container
          style={{ display: "flex", minHeight: "auto", height: "auto" }}
        >
          <Navbar.Brand href="/farmer-menu" className="text-white fw-bold">
            <i className="bi bi-tree-fill me-2"></i>
            Intelligent Farm Operations Platform with Smart Agro Precision
            System
          </Navbar.Brand>
        ...
        >
          <Row className="align-items-center">
            <Col lg={7}>
              ...
              >
                INTELLIGENT FARM OPERATION PLATFORM
              </span>
              ...
              >
                Manage your farms, crops and AI-powered agriculture insights all
                in one place.
              </p>
            </Col>
      ...
      <div className="py-3 px-4 border-top d-flex justify-content-between align-items-center flex-wrap">
        <span className="text-muted small">
          ...
          {new Date().getFullYear()} Intelligent Farm Operations Platform. All
          rights reserved.
        </span>
...
const ModuleCard = ({
  ...
  >
    ...
    <Card.Body className="p-4" style={{ textAlign: "left" }}>
      ...
      <ul
        className="mb-4"
        style={{ textAlign: "left", paddingLeft: 0, listStyle: "none" }}
      >
        {items.map((item) => (
...
//           Farm Verse
//         </h1>
//         <p>Welcome to Farmer Dashboard</p>
//       </div>
...
//               <a href="/farm-add"> Farm Entry</a>
//               <a href="/farm-list"> Farm List</a>
//               <a href="/crop-add"> Crop Entry</a>
//               <a href="/crop-list"> Crop List</a>
//             </div>
//           </li>
...
//           <img
//             className="farm-img"
//             src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjWmLCHqayQg1qQB6wyfUyseP9u9DiZz9-oc91eZXr6A&s=10"
//             alt="Farm Management"
//           />
...
//             <button onClick={() => navigate("/farm-add")}>Add Farm</button>
...
//           <img
//             className="farm-img"
//             src="https://plus.unsplash.com/premium_photo-1661904674420-d01a68b8965b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Njl8fGNyb3B8ZW58MHx8MHx8fDA%3D"
//             alt="Crop Management"
//           />
...
//           <div className="card-buttons">
//             <button onClick={() => navigate("/crop-add")}>Add Crop</button>
