...
const PREDICT_URL = "http://localhost:9696/farmverse/predict";
...
const CropInputsView = () => {
  ...
  //         // Store AI result in state
  //         setCropInputs(response.data);

  //         // Automatically save AI result to PostgreSQL
  //         return addCropInputs(response.data);
  //       })
  //       .then(() => {
  //         console.log("AI predicted crop inputs automatically saved.");

  //         setMessage("AI prediction generated and automatically saved.");
  //         setLoading(false);
  //       })
  //       .catch((err) => {
  //         console.log("AI Prediction/Save Error:", err);

  //         setLoading(false);
  //         setError("Unable to generate or save crop input prediction.");
  //       });
  //   };
